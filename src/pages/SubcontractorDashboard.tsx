...
const MyProfile = lazy(() => import('@/components/subcontractor/MyProfile'));
const MarketingAnalytics = lazy(() => import('@/components/subcontractor/MarketingAnalytics'));
const EnhancedAICopilot = lazy(() => import('@/components/subcontractor/EnhancedAICopilot'));
...
const EnhancedMessages = lazy(() => import('@/components/subcontractor/EnhancedMessages'));
const Messages = lazy(() => import('@/components/subcontractor/Messages'));
const AdvancedProjectManagement = lazy(() => import('@/components/subcontractor/AdvancedProjectManagement'));
