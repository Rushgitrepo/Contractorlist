...
const Articles = () => {
  ...
  const featuredArticle = {
    id: 1,
    title:
      "The Future of Construction: How AI and Automation Are Transforming the Industry",
    excerpt:
      "Explore the revolutionary impact of artificial intelligence and automation technologies on modern construction practices, from project planning to execution.",
    author: "Sarah Johnson",
    date: "2024-01-15",
    readTime: "8 min read",
    category: "Technology",
    image: "constructionAboutUs.jpg",
    featured: true,
  };
  ...
  const articles = [
    {
      ...
      excerpt:
        "Discover eco-friendly materials and practices that are reshaping the construction industry while reducing environmental impact.",
      author: "Mike Davis",
      date: "2024-01-12",
      readTime: "6 min read",
    ...
    },
    {
      ...
      excerpt:
        "Learn proven project management techniques that ensure on-time, on-budget delivery of construction projects.",
      author: "John Smith",
      date: "2024-01-10",
      readTime: "7 min read",
    ...
    },
    {
      ...
      excerpt:
        "Stay compliant with the newest safety regulations and best practices to protect your workforce and projects.",
      author: "Lisa Chen",
      date: "2024-01-08",
      readTime: "5 min read",
    ...
    },
    {
      ...
      excerpt:
        "Understand how Building Information Modeling is transforming project visualization and coordination.",
      author: "David Wilson",
      date: "2024-01-05",
      readTime: "9 min read",
      category: "Technology",
    ...
    },
    {
      ...
      excerpt:
        "Master the art of budget management with proven strategies for keeping construction costs under control.",
    ...
    },
    {
      ...
      excerpt:
        "Explore how modular construction is changing the industry landscape with faster builds and improved quality.",
      ...
      <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          <p className="text-2xl mb-12 max-w-4xl mx-auto leading-relaxed opacity-90">
            Stay ahead of the curve with our comprehensive collection of
            articles covering the latest trends, best practices, and innovations
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    ...
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-medium ${
                        article.category === "Technology"
                          ...
                          : article.category === "Project Management"
                          ? "bg-orange-100 text-orange-800"
                          : article.category === "Safety & Compliance"
        ...
        <div className="bg-gradient-to-r from-gray-900 to-black rounded-3xl p-12 text-center text-white">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Get the latest industry insights, expert tips, and trending topics
