  ...
  const caseStudies = [
    {
      ...
      challenge:
        "Complex multi-phase construction in busy downtown area with strict timeline requirements and minimal disruption to surrounding businesses.",
      solution:
        "Implemented advanced project scheduling, 24/7 coordination system, and specialized noise reduction techniques. Used BIM modeling for precise planning.",
      results: [
    ...
    },
    {
      ...
      challenge:
        "High-end residential project requiring premium finishes, custom designs, and coordination with multiple specialty contractors.",
      solution:
        "Established dedicated quality control processes, implemented vendor management system, and created detailed milestone tracking for custom work.",
      results: [
    ...
    },
    {
      ...
      image: "/api/placeholder/600/400",
      challenge:
        "Large-scale industrial facility with specialized equipment installation, strict environmental regulations, and operational timeline constraints.",
      solution:
        "Coordinated with equipment manufacturers, implemented environmental compliance tracking, and used modular construction techniques for efficiency.",
      results: [
      ...
      <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          <p className="text-2xl mb-12 max-w-4xl mx-auto leading-relaxed opacity-90">
            Discover how we've helped construction professionals deliver
            exceptional results across diverse projects, from commercial
            complexes to residential developments. Each story represents our
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-gradient-to-r from-gray-900 to-black rounded-3xl p-12 text-center text-white mt-20">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Join the construction professionals who trust us to deliver
            exceptional results on their most important projects.
          </p>
